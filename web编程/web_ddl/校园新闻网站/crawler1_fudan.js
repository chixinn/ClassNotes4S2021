...
var date_format ="$('span.arti_update').text()";
var author_format = "$('span.arti_publisher').text()"
var content_format = "$('.wp_articlecontent').text()";
var source_format = "$('span.views','div.col_news_box').text()";
